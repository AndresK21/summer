        ...
        <?php
            foreach($data as $row){
                ...
                <tr>
                    ...
                    <td>$$row[subtotal]</td>
                    <td>
                        <a class='waves-effect waves-light modal-trigger espacio tooltipped' data-position='right' data-delay='50' data-tooltip='Editar cantidad' href='update.php?id=$row[id_detalle]'><i class='material-icons blue-text text-darken-3 prefix'>edit</i></a>
