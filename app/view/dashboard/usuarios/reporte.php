<?php
    ...
    $header = array('Nombre completo', 'Usuario', 'Correo electronico');
    // Carga de datos
    $sql = "SELECT id_empleado, nombre_completo, correo_electronico, nombre_usuario FROM empleado ORDER BY nombre_completo";
    $params = array(null);
