<?php
    ...
    $header = array('Nombre', 'Presentacion', 'Cantidad', 'Precio U.');
    // Carga de datos
    $sql = "SELECT id_producto, nombre, cantidad, precio, categoria, presentacion FROM producto INNER JOIN categoria USING(id_categoria) INNER JOIN presentaciones USING(id_presentacion) ORDER BY nombre";
    $params = array(null);
