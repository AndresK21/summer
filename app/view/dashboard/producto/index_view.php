...
<div class="row">
    <div class="col s12">
        <ul class="tabs blue-grey-text text-darken-4">
            <li class="tab col s4"><a class="active black-text" href="#test1">Productos</a></li>
            <li class="tab col s4"><a class="black-text" href="#test3">Categor&Iacute;a</a></li>
            <li class="tab col s4"><a class="black-text" href="#test4">Presentaciones</a></li>
        </ul>
    </div>
